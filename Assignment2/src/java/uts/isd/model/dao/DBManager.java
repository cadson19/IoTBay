...
//----------------Alex's User Database Manager Functions-----------------------------------------------------------------------
    ...
    public ArrayList<Supplier> fetchSuppliers() throws SQLException {
        String fetch = "select * from SUPPLIERS";
        ResultSet rs = st.executeQuery(fetch);
        ...
        while(rs.next()){
            ...
            suppliers.add(new Supplier(contactName, companyName, email, address, status));
        }
        return suppliers;
    }
    
    public ArrayList<Supplier> findSupplier(String contactName, String companyName) throws SQLException{
        String fetch = "select * from ISDUSER.Suppliers where CONTACTNAME = '" + contactName + "' and company = '" +companyName + "'";
        ResultSet rs = st.executeQuery(fetch);
        ArrayList<Supplier> suppliers = new ArrayList();
    ...
    public void addSupplier(String contactName, String companyName, String email, String address, String status) throws SQLException{
        st.executeUpdate("INSERT INTO ISDUSER.Suppliers " + "VALUES ('" + contactName + "', '" + companyName + "', '" + email + "', '" + address + "',  '" + status + "')");
    }
    
    public void deleteDeleteSupplier(String companyName) throws SQLException {
        st.executeUpdate("DELETE FROM  ISDUSER.Suppliers WHERE COMPANYNAME = '" + companyName + "'");
    }
